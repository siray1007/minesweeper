...
TEXTS = {
    ...
    'wy': {
        ...
        'btn_login': '登 入', 'btn_register': '註 冊',
        'no_account': '未有賬號乎？', 'has_account': '已有賬號乎？',
        'to_register': '前往註冊', 'to_login': '返回登入',
        'warn_empty': '名號與暗碼不可為空！', 'login_fail': '登入敗矣',
        'reg_fail': '註冊敗矣', 'reg_ok': '註冊成矣！',
        'pwd_mismatch': '兩次暗碼不符！', 'user_exists': '此名號已存！',
        'pwd_short': '暗碼至少需四字！', 'user_short': '名號至少需二字！',
        'pwd_hint': '暗碼（至少四字）',
        'menu_title': '擇其難易', 'welcome': '恭迎，{}！',
        'diff_easy': '🟢 簡易 九乘九', 'diff_medium': '🟡 進階 廿七乘廿七', 'diff_hard': '🔴 艱難 八十一乘八十一',
        'desc_easy': '十雷 · 初學者', 'desc_medium': '百雷 · 高手之途',
        'desc_hard': '八百雷 · 極限之戰',
        'btn_start': '開始對局', 'btn_ranking': '🏆 英雄榜', 'btn_logout': '🚪 登出',
        'btn_back': '← 歸去', 'btn_restart': '🔄 重開一局',
        'game_over': '局終', 'game_over_msg': '💥 汝觸雷矣！\\n局終！',
        'win_title': '大捷！', 'win_msg': '🎉 汝勝矣！\\n\\n難度：{}\\n用時：{}\\n\\n戰績已錄！',
        'rank_title': '🏆 英雄榜', 'my_records': '📋 吾之戰績',
        'rank_col': '名次', 'user_col': '名號', 'time_col': '用時', 'date_col': '日期',
        'no_data': '暫無記錄', 'no_records': '暫無戰績',
        'difficulty_col': '難度', 'current_user': '玩家：{}',

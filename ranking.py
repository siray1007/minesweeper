...
class RankingFrame(tk.Frame):
    ...
    def _build_ui(self):
        ...
        for diff_key,diff_label in DIFFICULTY_LABELS:
            frame=tk.Frame(nb,bg='#1a1a2e');nb.add(frame,text=diff_label);self._build_table(frame,diff_key)
        my_frame=tk.Frame(nb,bg='#1a1a2e');nb.add(my_frame,text=t('my_records'));self._build_my_records(my_frame)

...
class AuthWindow(tk.Toplevel):
    ...
    def create_login_ui(self):
        self._clear()
        self.title("扫雷 - 登录")
        tk.Label(self, text="💣 扫雷游戏", font=('微软雅黑', 22, 'bold'), bg='#f0f0f0', fg='#333').pack(pady=(30, 5))
        tk.Label(self, text="登录账号", font=('微软雅黑', 14), bg='#f0f0f0', fg='#666').pack(pady=(0, 20))
    ...
    def create_register_ui(self):
        ...
        self.title("扫雷 - 注册")
        tk.Label(self, text="💣 扫雷游戏", font=('微软雅黑', 22, 'bold'), bg='#f0f0f0', fg='#333').pack(pady=(30, 5))
        tk.Label(self, text="注册新账号", font=('微软雅黑', 14), bg='#f0f0f0', fg='#666').pack(pady=(0, 20))
        tk.Label(self, text="用户名", bg='#f0f0f0', font=('微软雅黑', 10)).pack()
